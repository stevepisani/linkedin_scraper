...
def login(driver, email=None, password=None, cookie = None, timeout=10):
  ...
  email_elem = driver.findElement(By.cssSelector("#username"))
  email_elem.send_keys(email)

  password_elem = driver.findElement(By.cssSelector("#password"))
  password_elem.send_keys(password)
  password_elem.submit()

  try:
    if driver.url == 'https://www.linkedin.com/checkpoint/lg/login-submit':
      remember = driver.findElement(By.cssSelector('#'+c.REMEMBER_PROMPT))
      if remember:
        remember.submit()
